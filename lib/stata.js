...
CodeMirror.defineSimpleMode("stata",{
  ...
  start: [
    ...
    {regex: new RegExp('\\s' + builtins_str), token: color_translator['keyword']},
    {regex: new RegExp(builtins_str), token: color_translator['keyword'], sol: true},

    {regex: new RegExp('\\s' + builtins_fun_str), token: color_translator['def']},
